...
class CreateTicketTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ticket_transactions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('lesson_student_id')->nullable()->comment('レッスンID'); // レッスンID (NULL許可)
            ...
            $table->foreign('lesson_student_id')->references('id')->on('lesson_students')->onDelete('set null');
        });
    }
