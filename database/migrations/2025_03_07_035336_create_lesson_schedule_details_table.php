...
return new class extends Migration
{
  ...
  public function up(): void
  {
    Schema::create('lesson_schedule_details', function (Blueprint $table) {
      $table->id();
      $table->foreignId('lesson_schedule_id')->nullable()->constrained('lesson_schedules')->onDelete('cascade')->comment('レッスンID');
      $table->foreignId('staff_id')->nullable()->constrained('staff')->onDelete('cascade')->comment('メインコーチID');
