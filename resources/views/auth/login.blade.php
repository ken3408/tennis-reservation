  ...
  <main class="main">
      ...
      <div class="login-content">
        ...
        <form id="loginForm" class="login-form" action="{{ route('login.post') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input id="email" type="email" placeholder="example@mail.com" class="form-input" required />
          </div>
    ...
    <button id="scrollTopBtn" class="scroll-top-button">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="chevron-up">
