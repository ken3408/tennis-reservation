            ...
            <div class="date-time-container">
                <div class="date-container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="calendar-icon">
                ...
                <div class="time-container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="clock-icon">
                    ...
                    <div class="class-info">
                        <h3 class="class-level">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                stroke-linecap="round" stroke-linejoin="round" class="award-icon">
                        ...
                        <p class="coach-name">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="user-circle-icon">
                                <circle cx="12" cy="12" r="10"></circle>
                    ...
                    <div class="class-info">
                        <div class="class-level-container">
                            <h3 class="class-level class-level-canceled">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="award-icon-canceled">
                                    <circle cx="12" cy="8" r="6"></circle>
                                    <path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"></path>
                                </svg>
                                初中級
            ...
            <button class="nav-item nav-item-active">
                <div class="nav-icon-container nav-icon-container-active">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="nav-icon nav-icon-active">
                        <rect width="18" height="18" x="3" y="4" rx="2" ry="2"></rect>
                        <line x1="16" x2="16" y1="2" y2="6"></line>
                        <line x1="8" x2="8" y1="2" y2="6"></line>
                        <line x1="3" x2="21" y1="10" y2="10"></line>
